        # Kmdigitizer: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/kmdigitizer.git

        ## Objective

        KMDigitizer automates the extraction of individual patient-level survival data from published Kaplan-Meier curves for use in meta-analysis and secondary modelling.
        ...
        - Code: https://github.com/mahmood726-cyber/kmdigitizer.git
        - Dashboard: https://mahmood726-cyber.github.io/kmdigitizer/
